...
@section('content')
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <h5 class="card-header"> Formulario de categoria: {{$categoria->nombre}}</h5>
                    <form class="needs-validation" novalidate="" action="{{route("categoria.update",$categoria->id)}}" method="POST">
                        @method('PUT')
