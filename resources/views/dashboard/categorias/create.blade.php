...
@section('content')
    ...
    <header class="page-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h1 class="separator">Creando Categoria</h1>
    ...
    <div class="col-md-6">
        <div class="card">
            <h5 class="card-header">Formulario Categoria</h5>
            <form class="needs-validation" novalidate="" action="{{route("categoria.store")}}" method="POST">
