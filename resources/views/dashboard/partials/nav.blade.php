                ...
                <div class="dropdown-header pb-3">
                    <div class="media d-user">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 mb-0">{{auth()->user()->name}} {{auth()->user()->apellido}}</h5>
                            <span>{{auth()->user()->email}}</span>
                        </div>
                    </div>
                </div>
                <a class="dropdown-item" href="apps.messages.html"><i class="icon dripicons-mail"></i> Mensajes <span class="badge badge-accent rounded-circle w-15 h-15 p-0 font-size-10">4</span></a>
            <a class="dropdown-item" href="pages.profile.html"><i class="icon dripicons-user"></i> Perfil</a>

                <a class="dropdown-item" href="pages.my-account.html"><i class="icon dripicons-gear"></i>Configuracion de cuenta </a>
