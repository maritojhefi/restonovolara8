...
@section('content')
    ...
    <header class="page-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h1 class="separator">Creando Mesa</h1>
    ...
    <div class="col-md-6">
        <div class="card">
            <h5 class="card-header">Formulario Mesa</h5>
            <form class="needs-validation" novalidate="" action="{{route("mesa.store")}}" method="POST">
                 @include('dashboard.mesas.form')
           </form>
        </div>
    </div>
