        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <h3>A ORILLAS DEL GUADALQUIVIR</h3>
                    <p> Nuestra mision es brindar un ambiente acogedor para todo aquel cliente que alberguemos, ademas de ofrecer una gran variedad de platos y bebidas, entre varios de ellos, tipicos de la región...</p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <div class="about-images">
                        <img class="about-main" style="width: 300px" src="{{asset('images/logo.png')}}" alt="About Main Image">
                        <img class="about-inset" style="width: 50px" src="{{asset('images/comida.png')}}" alt="About Inset Image">
                    </div>
                </div>
            </div>
            <!-- end col -->
